      ...
      <section className='sm:px-32'>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:items-center md:gap-8">
            <div>
              <div className="max-w-lg md:max-w-none">
                ...
                <p className="inline-flex items-center mt-8 bg-gray-900 text-white hover:bg-orange-500 transition duration-700 ease-in-out py-2 px-6 gap-2 rounded ">
        ...
        <div className="bg-white py-5 md:py-5">
          <div className="max-w-screen-xl mx-auto">
            <h2 className="font-black text-black text-center text-2xl leading-none uppercase max-w-2xl mx-auto mb-12">What Our <span className='text-orange-500'>Customers</span> Are Saying About Us</h2>
            <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative">
              <div className="border border-orange-500 rounded-lg p-8 text-center md:w-1/3">
                <p className="font-bold  underline underline-offset-4 decoration-orange-500 mb-3">Priya Sharma</p>
                <p className="text-base font-light italic text-gray-700">
                  ASDL’s recruitment services were exactly what my company needed. They helped us hire skilled IT professionals from Bangladesh who now work remotely for us in India. The process was seamless, and their team was highly supportive.</p>
                <div className="flex items-center justify-center space-x-2 mt-4">
                  <svg className="text-orange-500 w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
              ...
              <div className="border border-orange-500 rounded-lg p-8 text-center md:w-1/3">
                <p className="font-bold  underline underline-offset-4 decoration-orange-500 mb-3">Daniel Peterson</p>
                <p className="text-base font-light italic text-gray-700">

                  We partnered with ASDL for risk advisory services, and their insights into compliance and governance were invaluable. Their expertise gave us confidence and helped streamline our processes.            </p>
                <div className="flex items-center justify-center space-x-2 mt-4">
                  <svg className="text-orange-500 w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    fill="currentColor" stroke="currentColor">
                    <path
              ...
              <div className="border border-orange-500 rounded-lg p-8 text-center md:w-1/3">
                <p className="font-bold  underline underline-offset-4 decoration-orange-500 mb-3">Emily Carter</p>
                <p className="text-base font-light italic text-gray-700">
                  I enrolled in a web development course through Instructorium, and it was amazing. The hands-on training and real-world projects prepared me for a career shift. The trainers were highly skilled and supportive.</p>
                <div className="flex items-center justify-center space-x-2 mt-4">
                  <svg className="text-orange-500 w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    fill="currentColor" stroke="currentColor">
                    <path
